...
<title>Admin Page-SaharaTech</title>
      ...
      <div class="row mt-3">
           ...
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#show-category-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/add-Category.webp" alt="users_pic" >
                         </div>
      ...
      <div class="row mt-3" >
           <div class="col-md-4">
                 <div class="card hover" data-toggle="modal" data-target="#total-order-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/tick.png" alt="users_pic" >
                         </div>
           ...
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#add-product-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/cartt.png" alt="users_pic" >
                         </div>
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post">
               ...
               <div class="container text-center">
                   <button class="btn bg-dark text-white">Add Category</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
               ...
               <div class="container text-center">
                   <button class="btn bg-dark text-white">Add Product</button>
                   <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
               </div>   
          </form>
      </div>
   ...
   %>
    <tr class="text-center">
      ...
      <form action="OrderServlet" method="post">
          ...
          <button type="submit" class="btn bg-dark text-white mb-2">Set</button>
     </form>
     </td>
    </tr>
    <%
