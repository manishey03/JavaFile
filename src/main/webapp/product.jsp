         ...
         <div class="col-md-2" >
             <div class="list-group mt-4">
               ...
               <%
                    ...
                    {    	
               %>      
                         <a href="index.jsp?category=<%=c.getCategoryId() %>" class="list-group-item list-group-item-action  <%if(catId==c.getCategoryId()){ %> active custom-bg<%} %>" <%if(catId==c.getCategoryId()){ %> style="border:#198754"<%} %>><%=c.getCategoryTitle() %></a>
               <%
                    }
               %>
             </div>
