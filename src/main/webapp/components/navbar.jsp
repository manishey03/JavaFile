...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>SaharaTech</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="ProductOperationServlet" method="post">
      ...
      <button type="submit" class="btn btn-white" style="color:#000"><b>Search</b></button>
    </form>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     <li class="nav-item active" data-toggle="modal" data-target="#showmycartmodal">
                        <div class="nav-link"><img src="images/Nav cart.png" style="width:23px;" alt="img">(<%=new CartDaoImp().totalCartByUserId(user.getUserId()) %>)</div>
                     </li> 
...
<div class="modal fade" id="showprofilemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="container text-center">
       <button type="button" class="btn bg-success text-light" data-dismiss="modal">Close</button>
  </div>   
</form>
      </div>
    </div>
...
<div class="row">
      ...
      <button type="button" class="btn btn-success ml-5" data-dismiss="modal">Close</button>
</div>
...
<div class="modal fade logout-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-body text-center">
          ...
          <div class="text-center">
            <a href="LoginServlet"><button type="button" class="btn bg-success text-white">Yes</button></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              "At Sahara Tech, we're more than just an electronic store, we're your gateway to cutting-edge technology and unparalleled customer service. With a passion for innovation and a commitment to excellence, we strive to bring you the latest and greatest in electronics, from state-of-the-art smartphones and sleek laptops to immersive home entertainment systems and smart gadgets that enhance your everyday life. Our knowledgeable team is here to guide you every step of the way, ensuring you find the perfect solution to fit your needs. Whether you're a tech enthusiast looking for the newest releases or a casual shopper seeking reliable electronics, Sahara Tech is your trusted partner in the world of technology."
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
                ...
                <img src="images/phones.png" style="width:27px;" alt="img">061-654733<br>
                &nbsp; &nbsp;<img src="images/email.png" style="width:29px;" alt="img"> saharatech@gmail.com <br>
                <img src="images/groupPhoto.jpg" width=730px height=650px align="middle">  <br>
                            	&nbsp; &nbsp; SaharaTech Developer Team &nbsp; &nbsp;<img src="images/email.png" style="width:29px;" alt="img"> saharatech@gmail.com <br/>
                                &nbsp; &nbsp;<img src="images/location.png"  style="width:27px;" alt="img">    Address: NewRoad-03, Kaski.    
        </p>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal fade changepasswordmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="container text-center">
       ...
       <input type="submit" class="btn bg-success text-light" value="Change">
       <button type="button" class="btn bg-dark text-light ml-5" data-dismiss="modal">Close</button>
...
<div class="modal fade forgetpasswordmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="container text-center">
       ...
       <input type="submit" class="btn bg-success text-light" value="Change">
       <button type="button" class="btn bg-dark text-white ml-5" data-dismiss="modal">Close</button>
